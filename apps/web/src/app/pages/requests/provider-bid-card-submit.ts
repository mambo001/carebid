...
export type ProviderBidFormValues = Omit<
  BidInput,
  "amount" | "availableDate"
> & {
...
export const providerBidInitialValues = (
  requestId: string,
  existingBid?: Bid | null,
): ProviderBidFormValues => ({
  requestId,
  amount: existingBid?.amount ?? 1200,
  availableDate: existingBid
    ? formDateFromApiDate(existingBid.availableDate)
    : new Date(),
